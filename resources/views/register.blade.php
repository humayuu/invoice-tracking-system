...
<head>
    ...
    <title>Register - InvoiceTracker</title>
                ...
                <div class="login-right mt-5">
                    <div class="login-form-wrap fade-up">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3">
                            ...
                            <span style="font-size:0.8rem;color:var(--text-muted);white-space:nowrap;">or register with
                                email</span>
                            <hr class="flex-grow-1 m-0" style="border-color:#e5e7eb;">
                        </div>
                        ...
                        <form method="POST" action="/register">
                            ...
                            <button type="submit" class="btn btn-dark w-100 py-2 fw-semibold mb-3" id="registerBtn">
