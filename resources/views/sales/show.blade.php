                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <div class="rounded-circle bg-primary bg-opacity-10 text-primary
                                ...
                                {{ function_exists('mb_strtoupper') ? mb_strtoupper(mb_substr($sale->client->name, 0, 2)) : strtoupper(substr($sale->client->name, 0, 2)) }}
                            </div>
                            <div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-end gap-2 flex-wrap">
                            ...
                            <button type="button" class="btn btn-danger px-4 btn-global-delete-confirm"
                                ...
                                data-delete-message="{{ 'Permanently delete invoice '.$sale->invoice_no.'?' }}"
