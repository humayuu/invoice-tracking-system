    ...
    <div class="page-content p-4 flex-grow-1 overflow-auto fade-up">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <div>
                ...
                <h4 class="fw-bold mb-0">Invoices — {{ $client->name }}</h4>
                        ...
                        <tbody>
                            @forelse ($invoices as $inv)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('sales.show', $inv) }}" class="btn btn-sm btn-dark">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-5">No invoices for this client.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
