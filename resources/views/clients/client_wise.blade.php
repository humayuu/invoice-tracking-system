            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                        <div>
                            <a href="{{ route('client.index') }}" class="btn btn-sm btn-outline-secondary mb-2">
                                <i class="fa-solid fa-arrow-left me-1"></i> Clients
                            </a>
                            <h4 class="mb-1">{{ $client->name }} — Pending &amp; overdue invoices</h4>
                            <p class="text-muted mb-0">
                                Credit Period: {{ $client->credit_period }} days
                                @if ($client->email)
                                    <span class="mx-2">|</span> {{ $client->email }}
                                @endif
                            </p>
                        </div>
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('client.wise.invoices.pdf', $client->id) }}" class="btn btn-outline-danger">
                                <i class="fa-solid fa-file-pdf me-1"></i> Export PDF
                            </a>
                            <a href="{{ route('client.wise.invoices.export', $client->id) }}" class="btn btn-outline-success">
                ...
                <div class="col-12" id="printArea">
                    <div class="print-header d-none">
                        <div class="text-center mb-4">
                            ...
                            <div class="mb-2">Credit Period: {{ $client->credit_period }} days</div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover invoice-table mb-0" id="invoiceTable">
                                    ...
                                    @else
                                        <tfoot>
                                            <tr>
                                                <td colspan="8" class="text-center text-muted py-4">No pending or overdue invoices for this client.</td>
                                            </tr>
                                        </tfoot>
                                    @endif
                                </table>
