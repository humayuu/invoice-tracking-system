...
Route::middleware(['auth', 'active', 'can.module:dashboard'])->group(function () {
    Route::get('/dashboard', DashboardController::class)->name('dashboard');
});

Route::middleware(['auth', 'active', 'can.module:reports'])->group(function () {
...
Route::middleware(['auth', 'active', 'can.module:sales'])->group(function () {
...
Route::middleware(['auth', 'active', 'can.module:purchase'])->group(function () {
...
Route::middleware(['auth', 'active', 'can.module:clients'])->group(function () {
...
Route::middleware(['auth', 'active', 'can.module:suppliers'])->group(function () {
